...
void mosaic_gpu_launch_kernel(
    CUfunction function, uint32_t grid_x, uint32_t grid_y, uint32_t grid_z,
    uint32_t cluster_x, uint32_t cluster_y, uint32_t cluster_z,
    uint32_t block_x, uint32_t block_y, uint32_t block_z, uint32_t smem_bytes,
    bool programmatic_serialization, CUstream stream, void** params) {
